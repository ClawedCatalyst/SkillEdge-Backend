...
urlpatterns = [
    ...
    path(
        ...
        View_filtered_courses.as_view(),
        name="viewFilteredCourses",
    ),
    ...
    path(
        "course_feedback/<str:ck>/", Course_feedback.as_view(), name="course_feedback"
    ),
    ...
    path(
        "view_specific_lesson/",
        View_specific_course_lesson.as_view(),
        name="viewSpecificCourseLesson",
    ),
]
