...
class profileSerializer(ModelSerializer):
    class Meta:
        model = NewUserRegistration
        fields = ("name", "user_name" ,"picture", "gender","dateOfBirth","mobile","is_educator","email","interested")
        
        extra_kwargs = {'email': {'required': False ,"allow_null": True}, 'interested':{'required': False ,"allow_null": True}}
